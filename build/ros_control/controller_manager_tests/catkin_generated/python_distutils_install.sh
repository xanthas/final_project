...
echo_and_run cd "/home/hsr/tiago_public_ws/src/ros_control/controller_manager_tests"
...
echo_and_run /usr/bin/env \
    ...
    "/home/hsr/tiago_public_ws/src/ros_control/controller_manager_tests/setup.py" \
     \
    build --build-base "/home/hsr/tiago_public_ws/build/ros_control/controller_manager_tests" \
    install \
    --root="${DESTDIR-/}" \
