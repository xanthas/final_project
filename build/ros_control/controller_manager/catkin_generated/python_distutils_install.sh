...
echo_and_run cd "/home/hsr/tiago_public_ws/src/ros_control/controller_manager"
...
echo_and_run /usr/bin/env \
    ...
    "/home/hsr/tiago_public_ws/src/ros_control/controller_manager/setup.py" \
     \
    build --build-base "/home/hsr/tiago_public_ws/build/ros_control/controller_manager" \
    install \
    --root="${DESTDIR-/}" \
