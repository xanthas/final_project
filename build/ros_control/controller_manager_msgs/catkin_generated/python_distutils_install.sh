...
echo_and_run cd "/home/hsr/tiago_public_ws/src/ros_control/controller_manager_msgs"
...
echo_and_run /usr/bin/env \
    ...
    "/home/hsr/tiago_public_ws/src/ros_control/controller_manager_msgs/setup.py" \
     \
    build --build-base "/home/hsr/tiago_public_ws/build/ros_control/controller_manager_msgs" \
    install \
    --root="${DESTDIR-/}" \
