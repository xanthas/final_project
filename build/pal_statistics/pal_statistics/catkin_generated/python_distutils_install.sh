...
echo_and_run cd "/home/hsr/tiago_public_ws/src/pal_statistics/pal_statistics"
...
echo_and_run /usr/bin/env \
    ...
    "/home/hsr/tiago_public_ws/src/pal_statistics/pal_statistics/setup.py" \
     \
    build --build-base "/home/hsr/tiago_public_ws/build/pal_statistics/pal_statistics" \
    install \
    --root="${DESTDIR-/}" \
