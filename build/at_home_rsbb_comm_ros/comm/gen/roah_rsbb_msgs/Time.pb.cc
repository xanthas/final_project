...
Time::Time()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:roah_rsbb_msgs.Time)
}
...
Time::Time(const Time& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:roah_rsbb_msgs.Time)
}
...
Time::~Time() {
  // @@protoc_insertion_point(destructor:roah_rsbb_msgs.Time)
  SharedDtor();
}
...
void Time::Clear() {
// @@protoc_insertion_point(message_clear_start:roah_rsbb_msgs.Time)
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:roah_rsbb_msgs.Time)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:roah_rsbb_msgs.Time)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:roah_rsbb_msgs.Time)
  return false;
#undef DO_
}
...
void Time::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:roah_rsbb_msgs.Time)
  // required int64 sec = 1;
  if (has_sec()) {
  ...
  // @@protoc_insertion_point(serialize_end:roah_rsbb_msgs.Time)
}

::google::protobuf::uint8* Time::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:roah_rsbb_msgs.Time)
  // required int64 sec = 1;
  if (has_sec()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:roah_rsbb_msgs.Time)
  return target;
}

int Time::RequiredFieldsByteSizeFallback() const {
// @@protoc_insertion_point(required_fields_byte_size_fallback_start:roah_rsbb_msgs.Time)
  int total_size = 0;
...
// @@protoc_insertion_point(message_byte_size_start:roah_rsbb_msgs.Time)
  int total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:roah_rsbb_msgs.Time)
  ...
  const Time* source = 
      ::google::protobuf::internal::DynamicCastToGenerated<const Time>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:roah_rsbb_msgs.Time)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:roah_rsbb_msgs.Time)
    MergeFrom(*source);
  }
}

void Time::MergeFrom(const Time& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:roah_rsbb_msgs.Time)
  if (GOOGLE_PREDICT_FALSE(&from == this)) {
    ::google::protobuf::internal::MergeFromFail(__FILE__, __LINE__);
  }
...
// @@protoc_insertion_point(generalized_copy_from_start:roah_rsbb_msgs.Time)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:roah_rsbb_msgs.Time)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
