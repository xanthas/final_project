...
if("TRUE" STREQUAL "TRUE")
  set(manipulation_SOURCE_PREFIX /home/hsr/tiago_public_ws/src/CDT2019-ERL/GAAN/manipulation)
  set(manipulation_DEVEL_PREFIX /home/hsr/tiago_public_ws/devel)
  ...
  set(manipulation_INSTALL_PREFIX /home/hsr/tiago_public_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'emilyrp <emilyrp@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'manipulation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hsr/tiago_public_ws/src/CDT2019-ERL/GAAN/manipulation/${idir}'.  ${_report}")
    endif()
