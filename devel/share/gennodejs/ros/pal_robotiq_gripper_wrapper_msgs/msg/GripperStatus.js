...
// (in-package pal_robotiq_gripper_wrapper_msgs.msg)
...
class GripperStatus {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('fingers_distance')) {
        this.fingers_distance = initObj.fingers_distance
      }
      else {
        this.fingers_distance = 0.0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [fingers_distance]
    bufferOffset = _serializer.float64(obj.fingers_distance, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [fingers_distance]
    data.fingers_distance = _deserializer.float64(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    if (msg.fingers_distance !== undefined) {
      resolved.fingers_distance = msg.fingers_distance;
    }
    else {
      resolved.fingers_distance = 0.0
    }
