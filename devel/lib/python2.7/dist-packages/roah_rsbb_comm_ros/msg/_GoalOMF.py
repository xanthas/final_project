...
"""autogenerated by genpy from roah_rsbb_comm_ros/GoalOMF.msg. Do not edit."""
import codecs
import sys
...
class GoalOMF(genpy.Message):
  _md5sum = "1ecb2b723fb091fc72a4100a7999df09"
  _type = "roah_rsbb_comm_ros/GoalOMF"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """bool[] initial_state
uint32[] switches
"""
  __slots__ = ['initial_state','switches']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GoalOMF, self).__init__(*args, **kwds)
